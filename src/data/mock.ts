...
export const reports: ComplianceReport[] = [
  {
    ...
    "breakdown": [
      ...
      {
        "label": "Consumer Clarity",
        "score": 100
      },
      {
        "label": "Platform Policy Fit",
        "score": 100
      }
    ],
    "issues": [
      {
        ...
        "detail": "Automated checks found no breaches. The remaining points are reserved for sign-off by a compliance specialist before publication.",
        "severity": "Low",
        "clause": "Internal review standard — human sign-off before publication",
        "category": "Disclosure Completeness",
        "impact": 2,
        "recommendation": "Have a compliance specialist confirm sign-off before this campaign goes live."
      }
    ],
    "recommendations": [
    ...
    "timeline": [
      {
        ...
        "time": "2026-07-19 09:14"
      },
      {
        "label": "Compliance check run",
        "time": "2026-07-21 11:02"
      },
      {
        "label": "Report generated",
        "time": "2026-07-21 11:03"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "issues": [
      {
        ...
        "detail": "Legal outcomes depend on the facts and evidence of each case and can never be guaranteed to a prospective client. Found in the advertisement copy.",
        "severity": "Critical",
        ...
        "recommendation": "Remove the guarantee and state that outcomes depend on the circumstances of each case."
      },
      {
        "id": "legal-outcome-qualification",
        "title": "Missing outcome qualification",
        "detail": "The campaign refers to compensation or winning a case without explaining that the outcome depends on the circumstances and evidence.",
        "severity": "High",
        "clause": "CAP Code 3.9 — significant limitations and qualifications must be stated",
        "category": "Disclosure Completeness",
        "impact": 40,
        "recommendation": "State that outcomes depend on the facts of each case and are assessed individually."
      },
      {
        "id": "legal-fee-clarity",
        "title": "Unclear fee or charging information",
        "detail": "Claims such as \"no win, no fee\" must explain what the client may still pay, including any success fee or deductions.",
        "severity": "Medium",
        "clause": "CAP Code 3.9 / SRA Transparency Rules — costs information must be clear",
        "category": "Disclosure Completeness",
        "impact": 25,
        "recommendation": "State the success fee or deduction that applies and any costs the client could still owe."
      }
    ],
    "recommendations": [
    ...
    "timeline": [
      {
        "label": "Campaign created",
        "time": "2026-07-15 12:31"
      },
      {
        "label": "Compliance check run",
        "time": "2026-07-16 08:44"
      },
      {
        "label": "Report generated",
        "time": "2026-07-16 08:45"
      }
    ]
  },
  {
    ...
    "issues": [
      {
        ...
        "detail": "Significant conditions that affect who can actually get the advertised product are not stated.",
        "severity": "Medium",
        "clause": "CAP Code 3.9 — significant limitations and qualifications must be stated",
        "category": "Disclosure Completeness",
        "impact": 25,
    ...
    "recommendations": [
      "State the eligibility criteria and any conditions that limit the offer."
    ],
    "timeline": [
      {
        "label": "Campaign created",
        "time": "2026-07-09 14:02"
      },
      {
        "label": "Compliance check run",
...
export const recentActivity = [
  {
    "id": "a1",
    "text": "Q3 High-Yield Savings Launch scored 98% — low risk",
    "time": "2 hours ago"
  },
  {
    "id": "a2",
  ...
  {
    "id": "a3",
    "text": "Injury Claims Retargeting flagged as critical risk",
    "time": "Yesterday"
  },
  {
    "id": "a4",
    "text": "Compliance score updated for Weekend Free Spins Promo",
    "time": "2 days ago"
  },
  {
    "id": "a5",
